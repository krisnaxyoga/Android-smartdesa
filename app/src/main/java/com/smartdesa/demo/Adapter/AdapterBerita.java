...
//    private List<ModelBerita> filteredUserDataList;

    public AdapterBerita(Context ctx, List<ModelBerita> listberita){
        this.ctx = ctx;
        this.listberita = listberita;
//        this.filteredUserDataList = listberita;
    }

    @NonNull
    @Override
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_berita_terbaru,parent,false);
